...
; SetupOAM_DMA - Copies 10-byte OAM DMA routine to HRAM $FF80
; The routine transfers sprite data from $C700 to OAM ($FE00) via rDMA ($FF46)
SetupOAM_DMA::
Call_008_6e6d:
    ld de, $6e78
    ld hl, $ff80
...
; OAM DMA routine (copied to $FF80 at runtime):
;   ld a, $C7      ; source = $C700
;   ldh [rDMA], a  ; start OAM DMA
;   ld a, $28      ; wait 40 iterations (~160 cycles)
;   dec a / jr nz  ; spin loop
;   ret
OAM_DMA_Routine:
    db $3e, $c7, $e0, $46, $3e, $28, $3d, $20, $fd, $c9

; SaveCollisionMap - Copy 40 bytes from collision map ($c680) to $d1d1 in WRAM bank 3
    ld a, $03
    ldh [rSVBK], a
    ld de, $c680
    ld hl, $d1d1
...
; RestoreCollisionMap - Copy 40 bytes from $d1d1 back to collision map ($c680) in WRAM bank 3
    ld a, $03
    ldh [rSVBK], a
    ld de, $d1d1
    ld hl, $c680
