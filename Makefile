...
MAP_DEPS = $(wildcard data/maps/room_*/*.bin) $(wildcard data/maps/area_*/*.bin)
POLISHED_MAP_DEPS = $(wildcard maps/*.blk)
...
game.gbc: game.o $(MAP_DEPS) $(POLISHED_MAP_DEPS) $(TEXT_DEPS)
...
.PHONY: all clean extract-maps export-polished-maps extract-text
